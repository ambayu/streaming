...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body">
        <div class="row">
            <!-- Kolom Kiri: Status Streaming, PM2 Status, Log Stream -->
            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <ol class="list-group list-group-numbered">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-start">
                                            ...
                                            @if($loop->first)
                                            <span class="badge bg-success rounded-pill">Sedang Diputar</span>
                                            @endif
                                        </li>
                                        @endforeach
                                    </ol>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch mb-3">
                                        ...
                                        <label class="form-check-label" for="selectAllVideos">Pilih Semua Video</label>
                                    </div>
                                </div>
                                        ...
                                        <div class="card h-100 shadow-sm video-card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mt-2">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-outline-primary move-up-btn" data-video-id="{{ $video->id }}">
                                                        <i class="fas fa-arrow-up"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-outline-primary move-down-btn" data-video-id="{{ $video->id }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.move-up-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (checkbox && checkbox.checked) {
                const currentItem = document.querySelector(`#playlistOrder li[data-video-id="${videoId}"]`);
    ...
    document.getElementById('streamForm').addEventListener('submit', function(e) {
        const selectedVideos = Array.from(document.querySelectorAll('.video-checkbox:checked')).length;
        if (selectedVideos === 0) {
            e.preventDefault();
